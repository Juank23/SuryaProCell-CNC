...
void cekSerial(){
  ...
  if(Serial.available()>0){
    ...
    if(c == 4){ //if processing send 3 SetpointX + 1;
      setpointX++;
    }//end if c = 3
    
    if(c == 8){ //if processing send 4 SetpointX - 1;
      setpointX--;
    }//end if c = 4
    
    if(c == 16){ //if processing send 5 SetpointY + 1;
      setpointY++;
    }//end if c = 5
    
    if(c == 32){ //if processing send 6 SetpointY - 1;
      setpointY--;
    }//end if c = 6
    
    if(c == 64){ //if processing send 7 SetpointZ + 1;
      setpointZ++;
    }//end if c = 7
    
    if(c == 128){ //if processing send 8 SetpointZ - 1;
      setpointZ--;
    }//end if c = 8
